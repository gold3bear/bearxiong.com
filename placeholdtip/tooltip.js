// @plugin     : Placeholder Tooltip
// @version    : 1.0
// @author     : Sam Markiewicz
// @authorURL  : http://sammarkiewi.cz
// @projectURL : https://github.com/SamMarkiewicz/Placeholder-Tooltip

(function($) {

  $.fn.extend({

    placeholdTip: function(options) {
      ...
      var placeholdTipElements = $(this).find(options.elementsSelector);

      return this.each(function() {
        placeholdTipElements.each(function() {
          var input = $(this)
          var placeholder = input.attr('placeholder')
          var tooltip = $('<span></span>')

          //Tooltip content and basic setting
          tooltip.insertAfter(input).addClass('placeholdtip');
          tooltip.addClass('placeholdtip-' + options.tipPosition);
